#' Convert an object to class \code{shinystan}
#'
#' @param X A \code{stanfit}, \code{mcmclist} or 3D array of posterior samples.
#' If \code{X} is not a \code{stanfit} or \code{mcmclist} object then the
#' dimensions of the 3D array must correspond to iterations, chains, and parameters,
#' in that order.
